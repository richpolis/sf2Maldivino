...
use Richpolis\ShoppingCartBundle\Entity\Producto;
use Richpolis\ShoppingCartBundle\Form\ProductoType;
...
class ProductoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RichpolisShoppingCartBundle:Producto')->findAll();
     ...
     * @Method("POST")
     * @Template("RichpolisShoppingCartBundle:Producto:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RichpolisShoppingCartBundle:Producto')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("RichpolisShoppingCartBundle:Producto:edit.html.twig")
     */
