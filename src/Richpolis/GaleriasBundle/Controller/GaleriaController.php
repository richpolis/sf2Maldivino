...
class GaleriaController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        $form = $this->createCreateForm($entity,$filtro['tipo']);
        ...
        if ($form->isValid()) {
            ...
            $em->persist($entity);
            $em->flush();
            if(isset($filtro['return'])){
                $return = $filtro['return'];
                unset($filtro['return']);
                $this->setFilters($filtro);
                return $this->redirect($return.'?galeria='.$entity->getId());
            }else{
